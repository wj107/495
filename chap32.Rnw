...
I wrote an R script that creates a function, \texttt{se.estimate} \cite{johnson}, to accomplish these tasks and record the results for analysis.  The arguments of
